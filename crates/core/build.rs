...
fn main() {
    ...
    let nautilus_version = "0.1.0";

    // Set compile-time environment variables
    println!("cargo:rustc-env=NAUTILUS_VERSION={nautilus_version}");
    println!("cargo:rustc-env=NAUTILUS_USER_AGENT=nexuscore/{nautilus_version}");
    ...
    if env::var("CARGO_FEATURE_FFI").is_ok() {
        ...
        let c_header_path = crate_dir.join("../../nexuscore/core/includes/core.h");
        ...
        let cython_path = crate_dir.join("../../nexuscore/core/rust/core.pxd");
